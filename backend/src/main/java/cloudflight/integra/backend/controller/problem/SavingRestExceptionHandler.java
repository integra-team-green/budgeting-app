...
public class SavingRestExceptionHandler {
  ...
  public ResponseEntity<Object> handleCustomValidation(
  ...
  public ResponseEntity<Object> handleCustomRuntimeException(
      MoneyMindRuntimeException ex, HttpServletRequest req) {
  ...
  private ResponseEntity<Object> buildErrorResponse(
      HttpStatus status, String message, HttpServletRequest req, List<String> errors) {
