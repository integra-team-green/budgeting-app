...
class RestSavingControllerTests {
    ...
    void setUp() {
        Saving saving = new Saving(
                1L, new BigDecimal("10000.00"), new Date(), "Apartament", "I wish to have my owm apartament");
        ...
        TESTmockMvc = MockMvcBuilders.standaloneSetup(TESTrestSavingController).build();
    }
    ...
    void testGetById_NotFound() {
        try {
            TESTmockMvc.perform(get("/api/v1/savings/999")).andDo(print()).andExpect(status().isNotFound());
    ...
    void testDelete() throws Exception {
        ...
        TESTmockMvc.perform(delete("/api/v1/savings/2")).andDo(print()).andExpect(status().isNoContent());
    ...
    void testUpdate() throws Exception {
        ...
        Saving saving =
                new Saving(4L, new BigDecimal("6000.00"), new Date(), "Sicily trip - updated", "Mafia description");
        SavingDTO savingDTO = SavingMapper.toDTO(saving);
