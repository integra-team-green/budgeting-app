...
class IncomeRepositoryTest {
    ...
    void create_generatesAutoIncrementId() {
        Income income1 = new Income(
                null, user1.getId(), BigDecimal.valueOf(100), "Job", new Date(), "Salary", Frequency.MONTHLY, null);
        Income income2 = new Income(
                null, user2.getId(), BigDecimal.valueOf(200), "Gift", new Date(), "Birthday", Frequency.YEARLY, null);
    ...
    void update_changesExistingIncome() {
        Income income = new Income(
                null, user1.getId(), BigDecimal.valueOf(300), "Bonus", new Date(), "Year end", Frequency.MONTHLY, null);
        repository.save(income);
    ...
    void delete_removesIncome() {
        Income income = new Income(
                null, user1.getId(), BigDecimal.valueOf(400), "Lottery", new Date(), "Win", Frequency.MONTHLY, null);
        repository.save(income);
